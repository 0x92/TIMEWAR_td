...
- [ ] P-002: Codex-Checklist finalisiert & übernommen (dieses Dokument in Repo)
...
- [ ] T-001: Repo & Tooling (Vite + TS, PNPM, ESLint/Prettier, tsconfig Aliase)
- [ ] T-002: CI/CD (GitHub Actions: Lint/Test/Build + Preview)
- [ ] T-003: Basis-Ordnerstruktur mit Stubs/Interfaces
...
```json
{ "id":"phase_runner","hp":220,"speed":1.35,
